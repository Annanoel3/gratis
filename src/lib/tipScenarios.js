...
export const TIP_SCENARIOS = [
  // Dining & Food
  { id: "restaurant_sitdown", label: "Sit-down Restaurant", category: "Dining", type: "percent", min: 15, base: 18, max: 25, note: "Standard for table service" },
  ...
  { id: "restaurant_fine", label: "Fine Dining", category: "Dining", type: "percent", min: 20, base: 22, max: 25, note: "Higher expectation of service" },
  { id: "bartender", label: "Bartender", category: "Dining", type: "percent", min: 15, base: 20, max: 25, note: "Or $1–2 per drink" },
  ...
  { id: "catering", label: "Catering Staff", category: "Dining", type: "percent", min: 10, base: 15, max: 20, note: "On pre-tax total" },

  // Travel & Transport
  { id: "taxi", label: "Taxi / Rideshare (Uber, Lyft)", category: "Travel", type: "percent", min: 10, base: 15, max: 20, note: "Round up for short rides" },
  { id: "shuttle_driver", label: "Shuttle / Limo Driver", category: "Travel", type: "percent", min: 15, base: 18, max: 20, note: "On total fare" },
  { id: "valet", label: "Valet Parking", category: "Travel", type: "flat", min: 2, base: 5, max: 10, note: "Per car, on pickup" },
  ...
  // Hotels & Lodging
  { id: "hotel_housekeeping", label: "Hotel Housekeeping", category: "Hotel", type: "flat", min: 2, base: 5, max: 10, note: "Per night, left daily" },
  { id: "hotel_bellhop", label: "Bellhop / Porter", category: "Hotel", type: "flat", min: 1, base: 2, max: 5, note: "Per bag" },
  { id: "hotel_concierge", label: "Concierge", category: "Hotel", type: "flat", min: 5, base: 10, max: 20, note: "For special requests" },
  { id: "hotel_doorman", label: "Doorman", category: "Hotel", type: "flat", min: 1, base: 2, max: 5, note: "For hailing cab or help" },
  { id: "room_service", label: "Room Service", category: "Hotel", type: "percent", min: 15, base: 18, max: 20, note: "Check if gratuity included" },

  // Personal Care & Beauty
  { id: "hairdresser", label: "Hairdresser / Stylist", category: "Personal Care", type: "percent", min: 15, base: 20, max: 25, note: "Standard for salon services" },
  { id: "barber", label: "Barber", category: "Personal Care", type: "percent", min: 15, base: 20, max: 25, note: "Cash preferred" },
  { id: "nail_tech", label: "Nail Technician / Manicurist", category: "Personal Care", type: "percent", min: 15, base: 20, max: 25, note: "For mani/pedi services" },
  { id: "massage", label: "Massage Therapist", category: "Personal Care", type: "percent", min: 15, base: 20, max: 25, note: "Unless in a medical setting" },
  { id: "esthetician", label: "Esthetician / Facials / Waxing", category: "Personal Care", type: "percent", min: 15, base: 20, max: 25, note: "Same as salon" },
  ...
  { id: "spa", label: "Spa Services", category: "Personal Care", type: "percent", min: 15, base: 20, max: 20, note: "Check if auto-added" },
  ...
  { id: "golf_caddy", label: "Golf Caddy", category: "Other", type: "percent", min: 30, base: 40, max: 50, note: "On caddy fee" },
  { id: "ski_instructor", label: "Ski / Sports Instructor", category: "Other", type: "percent", min: 10, base: 15, max: 20, note: "Per lesson" },
  ...
  { id: "coat_check", label: "Coat Check", category: "Other", type: "flat", min: 1, base: 2, max: 3, note: "Per coat" },
...
export function computeTip({ scenario, bill, rating, mode, customPercent, people = 1 }) {
  ...
  if (mode === "custom") {
    ...
    const mult = RATING_MULTIPLIERS[rating]?.mult ?? 1;
    if (scenario.type === "flat") {
      tipAmount = scenario.base * mult;
      isFlat = true;
      effectivePercent = (tipAmount / bill) * 100;
    } else {
      const pct = scenario.base * mult;
      tipAmount = (bill * pct) / 100;
      effectivePercent = pct;
    }
  }
